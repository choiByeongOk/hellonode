...
exports.book_create_post = [
    ...
    sanitizeBody('*').escape(), // Is this bug? ... https://github.com/express-validator/express-validator/issues/791

    // Process request after validation and sanitization.
    (req, res, next) => {
        console.log('logging the checked genres1' + req.body.genre);
...
exports.book_delete_get = function(req, res, next) {
    ...
    async.parallel({
        ...
        res.render('book_delete', {
            title: 'Delete Book', book: results.book, book_instances: results.bookinstances
        });
    });
